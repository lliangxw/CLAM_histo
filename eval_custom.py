...
parser.add_argument('--testset_csv', type=str, default=None, help='custom csv for test set')
...
if args.task == 'task_1_CCA_vs_HCC':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/CCA_vs_HCC_256_SimCLR_all_for_test.csv',
...
if __name__ == "__main__":
    ...
    for ckpt_idx in range(len(ckpt_paths)):
        ...
        if datasets_id[args.split] < 0:
            ...
            print('len:' + str(len(split_dataset)))
